...
set psu_ddr_init_data {
    ...
    # vice in use Only present in designs that support DDR3.
		...
		# Master Register
		#(OFFSET, MASK, VALUE)      (0XFD070000, 0xE30FBE3DU ,0x83040010U)  */
    mask_write 0XFD070000 0xE30FBE3D 0x83040010
    ...
    # LPDDR3/LPDDR4 - Value to write to MR2 register
		...
		#(OFFSET, MASK, VALUE)      (0XFD0700DC, 0xFFFFFFFFU ,0x07340501U)  */
    mask_write 0XFD0700DC 0xFFFFFFFF 0x07340501
    ...
    # ed. - 0 - BG0 and BG1 are swapped if address mirroring is enabled.
		# PSU_DDRC_DIMMCTL_DIMM_DIS_BG_MIRRORING                                          0x1
    ...
    # nds to even and odd ranks seperately - 0 - Do not stagger accesses
		...
		#(OFFSET, MASK, VALUE)      (0XFD0700F0, 0x0000003FU ,0x00000032U)  */
    mask_write 0XFD0700F0 0x0000003F 0x00000032
    ...
    mask_write 0XFD0800C4 0xFFFFFFFF 0x000000E5
		...
		#(OFFSET, MASK, VALUE)      (0XFD080100, 0xFFFFFFFFU ,0x6800040CU)  */
    mask_write 0XFD080100 0xFFFFFFFF 0x6800040C
    ...
    mask_write 0XFD080508 0xFFFFFFFF 0x00000000
		...
		# PSU_DDR_PHY_ACIOCR3_BGOEMODE                                                    0x8
		...
		#(OFFSET, MASK, VALUE)      (0XFD08050C, 0xFFFFFFFFU ,0x20000005U)  */
    mask_write 0XFD08050C 0xFFFFFFFF 0x20000005
